	...
	private void doProcess(HttpServletRequest request, HttpServletResponse response)
		...
		if(request.getRequestURI().endsWith("searchform")) {
			...
			Student student = stdService.searchStudent(Integer.parseInt(sid));
			 ...
			 if(student!= null) {
				 ...
				 out.println("<tr><th>ID</th><td> " + student.getSname()+"</td></tr>");
				 out.println("<tr><th>ID</th><td> " + student.getSage()+"</td></tr>");
				 out.println("<tr><th>ID</th><td> " + student.getSaddress()+"</td></tr>");
				 out.println("</tabler>");
				 out.println("</center>");
				 out.println("</body>");
			 }else {
				 out.println("<h1 style='color:green; text-align:center;'>RECORD NOT AVAILABLE FOR THE GIVEN ID " + sid +"</h1>");
			 }
			 out.close();
		...
		if(request.getRequestURI().endsWith("deleteform")) {
			...
			String status  = stdService.deleteStudent(Integer.parseInt(sid));
			 ...
			 if(status.equals("success")) {
				 out.println("<body>");
				 out.println("<h1 style='color:green; text-align:center;'>RECORD Deleted FOR  THE GIVEN ID " + sid +"</h1>");
				 out.println("</body>");
			 }
			 else if (status.equals("failure")) {
				 out.println("<body>");
				 out.println("<h1 style='color:green; text-align:center;'>RECORD Deleted FAILED THE GIVEN ID " + sid +"</h1>");
				 out.println("</body>");
			 }else  {
				 out.println("<body>");
				 out.println("<h1 style='color:green; text-align:center;'>RECORD NOT  FOUND for DELETION ID " + sid +"</h1>");
				 out.println("</body>");
			         }
			 out.close();
			 }
